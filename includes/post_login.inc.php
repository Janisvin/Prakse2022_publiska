...
if ($_SERVER["REQUEST_METHOD"] == "POST")   //atjauno datus ar tālāk redzemās formas datiem
{
    ...
    if (empty($errorpw1) && empty($erroruid)) {
        ...
        $sql = "SELECT id, uid, pwd, email, bio, image, admin FROM users WHERE uid = ?";
        ...
        if ($stmt = mysqli_prepare($con, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                if (mysqli_stmt_num_rows($stmt) == 1) {
                    // apvieno mainīgos
                    mysqli_stmt_bind_result($stmt, $id, $uid, $hashed_password, $email, $bio, $image, $admin);
...
<div class="card mt-4 border-3">
    ...
    <div style="background-color: #495057;" class="card-title">
        <h3 class="text-white text-center py-3">Autorizēšanās</h3>
    </div>
    ...
    <div class="card-body">
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="row g-2">
                <div class="col">
                    ...
                    <div class="form-floating">
                        <input type="text" id="uid" name="uid" class="form-control mb-2" required>
                ...
                <div class="col">
                    ...
                    <div class="form-floating">
                        <input type="password" id="pw1" name="pw1" class="form-control mb-2" required>
            ...
            <p>Nav profila? <a href="../app/signup.php">Reģistrējies</a>.</p>
            ...
            <div class="d-flex justify-content-end">
                <div class="row">
                    <div class="col">
                        ...
                        <button class="btn btn-success" input type="submit" value="login">Apstiprināt</button>
