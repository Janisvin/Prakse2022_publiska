...
//lai nepazustu post vertiba pec paginacijas izmantošanas
$userid = $_SESSION["target"];
    ...
    <div class="card border-3 customcardbg mt-3 mb-0 mx-2 px-2 py-1">
        <div class="card-body">
            ...
            <div class="row justify-content-end">
                <a class="btn btn-close mx-2" href=<?php echo "../includes/delete_contact_user_admin.inc.php?delete=$user_data[contactid]" ?> name="delete"></a>
            </div>
